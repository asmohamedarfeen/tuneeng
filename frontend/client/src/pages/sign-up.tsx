  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast({
        ...
        description: "You can now sign in and start your demo/practice journey.",
      });

      // After successful sign up, send the user to the sign-in page
      navigate("/sign-in");
    } catch (error: any) {
      toast({
        ...
        <Card className="w-full shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-3 text-center pb-6">
            ...
            <CardDescription className="text-base text-slate-600">
              Join learners preparing for interviews and communication excellence
            </CardDescription>
          </CardHeader>
          <CardContent>
