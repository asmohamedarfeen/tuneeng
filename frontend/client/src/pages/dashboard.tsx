...
import { Menu, User, Headphones, Mic, BookOpen, PenTool, Trophy, LineChart, List } from "lucide-react";
  ...
  const allModules = [
    {
      ...
      tab: "listening",
      image: "/images/listening_module.png",
      color: "bg-emerald-50"
    },
    {
      ...
      tab: "reading",
      image: "/images/reading_module.png",
      color: "bg-orange-50"
    },
    {
      ...
      tab: "speaking",
      image: "/images/speaking_module.png",
      color: "bg-amber-50"
    },
    {
      ...
      tab: "writing",
      image: "/images/writing_module.png",
      color: "bg-stone-50"
    },
  ];
            ...
            <div className="border-b border-gray-200 pb-3 px-4">
              <div className="flex gap-8">
                <button
                  ...
                  className={`pb-3 px-2 text-sm font-bold border-b-2 transition-colors ${activeTab === 'listening'
                ...
                <button
                  ...
                  className={`pb-3 px-2 text-sm font-bold border-b-2 transition-colors ${activeTab === 'speaking'
                    ? 'border-blue-600 text-blue-600'
                    : 'border-transparent text-gray-600 hover:text-blue-600'
                    }`}
                >
                ...
                <button
                  ...
                  className={`pb-3 px-2 text-sm font-bold border-b-2 transition-colors ${activeTab === 'reading'
                    ? 'border-blue-600 text-blue-600'
                    : 'border-transparent text-gray-600 hover:text-blue-600'
                    }`}
                >
                ...
                <button
                  ...
                  className={`pb-3 px-2 text-sm font-bold border-b-2 transition-colors ${activeTab === 'writing'
                    ? 'border-blue-600 text-blue-600'
                    : 'border-transparent text-gray-600 hover:text-blue-600'
                    }`}
                >
              ...
              allModules.map((module, index) => (
                ...
                >
                  <div className="flex h-[280px]">
                    {/* Module Illustration */}
                    <div
                      className={`w-[400px] flex-shrink-0 ${module.color}`}
                    >
                      <img
                        src={module.image}
                        alt={module.title}
                    ...
                    {/* Module Content */}
                    <div className="flex-1 p-8 flex flex-col items-start justify-center bg-blue-50/10">
                      ...
                      <Link href={`/practice?tab=${module.tab}`}>
                        <Button className="bg-blue-500 hover:bg-blue-600 text-white font-medium px-6 py-2 h-auto rounded-md shadow-sm transition-colors">
                          Start Module
                        </Button>
                      </Link>
                    </div>
